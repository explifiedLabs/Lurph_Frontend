  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-4 mb-8">
        {supportLinks.map((link, index) => (
          <motion.a
            ...
            className="bg-linear-to-br from-black to-[#0a0a0a] border border-[#FFD600]/20 rounded-xl p-5 flex items-center justify-between hover:border-[#FFD600]/40 transition-all duration-200 group"
          >
      ...
      <motion.div
        ...
        className="bg-linear-to-br from-black to-[#0a0a0a] border border-[#FFD600]/20 rounded-xl p-6"
      >
