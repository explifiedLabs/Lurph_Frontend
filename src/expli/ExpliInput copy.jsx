      ...
      <div className="pointer-events-auto w-full max-w-[720px]">
        {showHero && (
          <div className="text-center mb-10">
            <h1 className="text-[clamp(2.5rem,6vw,4rem)] font-bold tracking-tight leading-[1.1] mb-3 text-transparent bg-clip-text bg-[linear-gradient(135deg,#e0e0e0_0%,#23b5b5_60%,#8b5cf6_100%)]">
              Expli
            </h1>
        ...
        <div
          className={`rounded-[20px] border transition-all duration-300 overflow-hidden backdrop-blur-xl bg-[#18181e]/95 ${
            prompt.trim()
